...
-- -- davem
-- -- -- adapted to my paths and calendars!
...
on run argv
	...
	deleteCalendarEvents("OmniFocus: Work")
	deleteCalendarEvents("OmniFocus: Home")
	
	-- Sync all of the calendars
	set tagsToSync to {"Home", "Errands"}
	processOmniFocusTasks(tagsToSync, "include", "Omnifocus: Home")
	
	set tagsToSync to {"Office", "Computer", "Reading"}
	processOmniFocusTasks(tagsToSync, "include", "Omnifocus: Work")
	
	set tagsToIgnore to {"Home", "Errands", "Office", "Computer", "Reading"}
